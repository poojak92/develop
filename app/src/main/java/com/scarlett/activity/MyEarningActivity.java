...
import com.scarlett.Fragment.ByPostFragment;
import com.scarlett.Fragment.FollwerFragment;
...
public class MyEarningActivity extends BaseToolbarActivity {
 //   private Toolbar toolbar;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FollwerFragment(), "Follwers");
        adapter.addFragment(new ByPostFragment(), "By Post");
